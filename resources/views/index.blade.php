    ...
    <section class="hero-banner" style="background-image: url('images/la-remise-en-banner.jpg')">
        ...
        <div class="container hero-content-wrap">
            <div class="row">
                ...
                <div class="tag-image">
                <img src="{{cloudfrontUrl('images/nouveaux-product-tag.png')}}" alt="Nouveaux Product">
                </div>
            </div>
        </div>
    </section>
    <section class="text-center discount-section">
      <div class="container">
        <div class="video mb-4">
          <a href="https://youtu.be/L-Kfz5lEKtc" target="__blank">
            <img src="{{cloudfrontUrl('images/la-remise-en-video.jpg')}}" alt="la-remise-en-video">
          </a>
        </div>
        <div class="row">
          <div class="col-12">
              <p>Vous faites confiance à Dell Technologies pour votre business et nous vous en sommes reconnaissants.</p>
              <p>En ayant acheté des produits Dell Technologies éligibles à ce programme, vous pouvez maintenant obtenir :
              </p>
              <h2>50€ par Poste Client (sur les gammes Latitude, Optiplex, Precision et Vostro éligibles),
                jusqu’à 70€ par Serveur Dell éligible et jusqu’à 35€ par écran Dell éligible</h2>
              ...
              <p>L‘offre est valable du 16.08.2021 au 12.09.2021</p>
              <p>et jusqu'à ce que le budget soit disponible</p>
          </div>
        </div>
      </div>
    </section>
                ...
                <div class="col-12">
                    ...
                    <ul class="howitworks-first">
                        <li><span class="round-block">&plus;</span>
                            <p>Achetez un produit éligible des gammes Dell Latitude, Optiplex, Precision ou Vostro, un serveur et/ou un écran Dell éligible auprès de l’un de nos distributeurs agréés en France.</p>
                        </li>
                        <li><span class="round-block">&plus;</span>
                    ...
                    <div class="accordion" id="accordionFAQ">
                        <div class="card">
                            ...
                            <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                                ...
                                <div class="card-body">
                                  Il s’agit des produits des gammes Dell Latitude, Dell Optiplex, Dell Precision et Dell Vostro, des serveurs ainsi que des écráns Dell éligibles (veuillez consulter la liste complète <a href="{{url('/terms-and-conditions')}}" target="__blank">ici</a>) identifiés par la mention « laremiseenplus » chez l’un de nos distributeurs agrées en France (Dell Authorized Distributor).
                                </div>
                            </div>
                        </div>
                        <div class="card">
                        ...
                        <div class="card">
                            ...
                            <div id="collapseSix" class="collapse" aria-labelledby="headingSix"
                                data-parent="#accordionFAQ">
                                <div class="card-body">
                                  Votre remboursement est de 50€ par unité éligible (Dell Latitude, Dell Optiplex, Dell Precision et Dell Vostro) dans la limite de 5 unités pour Dell Latitude, Dell Optiplex, Dell Precision et Dell Vostro par mois calendaire.<br>
                                  Votre remboursement va jusqu’à 70 € de Cashback revendeur par serveur Dell éligible, dans la limite de 5 serveurs par mois calendaire.<br> Votre remboursement va jusqu’à 45 € de Cashback revendeur par écran Dell éligible, dans la limite de 5 écrans par mois calendaire.
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div id="collapseSeven" class="collapse" aria-labelledby="headingSeven"
                                data-parent="#accordionFAQ">
                                <div class="card-body">
                                  Vous pouvez soumettre plusieurs demandes, dans la limite de 5 unités remboursables dans la catégorie ordinateurs de bureau et stations de travail, 5 unités dans la catégorie serveur et 5 unités dans la catégorie écran par mois calendaire dans la limite de la période de promotion.
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            ...
                            <div class="card-header" id="headingTwelve">
                                <h2 class="mb-0">
                                    <button class="btn btn-link collapsed" type="button" data-toggle="collapse"
                                        ...
                                        Que se passe-t-il si je ne reçois pas mon remboursement ?
                                    </button>
                                </h2>
                            </div>
                    ...
                    <main class="content" role="content">
                        ...
                        <form id="regForm" action="{{url('offer-claim') }}" method="POST"
                            ...
                            <div class="tab">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="bank_name">Nom de la banque *</label>
